...
class ModelCatalogManufacturer extends Model {
	public function addManufacturer($data) {
		...
		foreach ($data['manufacturer_description'] as $language_id => $value) {
			$this->db->query("INSERT INTO " . DB_PREFIX . "manuf_description SET manufacturer_id = '" . (int)$manufacturer_id . "', language_id = '" . (int)$language_id . "', meta_keyword = '" . $this->db->escape($value['meta_keyword']) . "', meta_description = '" . $this->db->escape($value['meta_description']) . "', u_title = '" . $this->db->escape($value['u_title']) . "', u_h1 = '". $this->db->escape($value['u_h1']) ."',u_h2 = '". $this->db->escape($value['u_h2']) ."', description = '" . $this->db->escape($value['description']) . "'");
		}
	...
	public function editManufacturer($manufacturer_id, $data) {
		...
		$this->db->query("DELETE FROM " . DB_PREFIX . "manuf_description WHERE manufacturer_id = '" . (int)$manufacturer_id . "'");
	...
	public function getManufacturerDescriptions($manufacturer_id) {
		$manuf_description_data = array();
				
		$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "manuf_description WHERE manufacturer_id = '" . (int)$manufacturer_id . "'");
				
			foreach ($query->rows as $result) {
				$manuf_description_data[$result['language_id']] = array(

  ...
  <div class="box">
    ...
    <div class="content">
      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        ...
        <div id="tab-store">          
           <!--Start_config_main--> 
				<div id="vtab-main" class="vtabs">
				<?php foreach ($languages as $language) { ?> 
				   <a href="#tab-main_<?php echo $language['language_id']; ?>"><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" style="float:left;"/><?php echo $language['name']; ?></a>				  
				<?php } ?>
				</div>				
				<?php foreach ($languages as $language) { ?>
				<div id="tab-main_<?php echo $language['language_id']; ?>" class="vtabs-content">
						<table class="form">
							<tr>
							  <td><span class="required">*</span> <?php echo $entry_title; ?></td>
							  <td>			  
							 <input type="text" name="main_title[<?php echo $language['language_id']; ?>]" value="<?php if (isset($main_title[$language['language_id']]['main_title'])) { echo $main_title[$language['language_id']]['main_title']; } ?>" />	
							</tr>
							<tr>
							  <td><?php echo $entry_h1; ?></td>
							  <td>
							  <input type="text" name="main_h1[<?php echo $language['language_id']; ?>]" value="<?php if (isset($main_h1[$language['language_id']]['main_h1'])) { echo $main_h1[$language['language_id']]['main_h1']; } ?>" />			 
							</td>
							</tr>
							<tr>
							  ...
							  <textarea name="main_meta_desc[<?php echo $language['language_id']; ?>]" cols="40" rows="5"><?php if (isset($main_meta_desc[$language['language_id']]['main_meta_desc'])) { echo $main_meta_desc[$language['language_id']]['main_meta_desc']; } ?></textarea>
							</tr>
							<tr>
							  <td><?php echo $entry_meta_keywords; ?></td>
							  <td>			  
							  <textarea name="main_meta_keyw[<?php echo $language['language_id']; ?>]" cols="40" rows="5"><?php if (isset($main_meta_keyw[$language['language_id']]['main_meta_keyw'])) { echo $main_meta_keyw[$language['language_id']]['main_meta_keyw']; } ?></textarea>
							</tr>
							<tr>
								<td><?php echo $entry_full_desc; ?></td>
								<td>
								<textarea name="main_desc[<?php echo $language['language_id']; ?>]" id="main_desc<?php echo $language['language_id']; ?>"><?php if (isset($main_desc[$language['language_id']]['main_desc'])) { echo $main_desc[$language['language_id']]['main_desc']; } ?></textarea>
								</td>
						   </tr>
						</table>
					</div>
        ...
        <div id="tab-option">
          ...
          <table class="form">
            ...
            <tr>
              <td><?php echo $entry_complete_status; ?></td>config_cancel_status_id
			...
			<tr>
              ...
              <td><select name="config_cancel_status_id">
                  <?php foreach ($order_statuses as $order_status) { ?>
                  <?php if ($order_status['order_status_id'] == $config_cancel_status_id) { ?>
                  <option value="<?php echo $order_status['order_status_id']; ?>" selected="selected"><?php echo $order_status['name']; ?></option>
                  <?php } else { ?>
                  <option value="<?php echo $order_status['order_status_id']; ?>"><?php echo $order_status['name']; ?></option>
                  <?php } ?>
        ...
        <div id="tab-server">
          <table class="form">
			...
			<tr>
              <td><?php echo $entry_yandex_metrika; ?></td>
              <td><textarea name="config_yandex_metrika" cols="40" rows="5"><?php echo $config_yandex_metrika; ?></textarea></td>
            </tr>
          </table>
        </div>
      </form>
...
<script type="text/javascript"><!--
	<?php foreach ($languages as $language) { ?>
		CKEDITOR.replace('main_desc<?php echo $language['language_id']; ?>', {

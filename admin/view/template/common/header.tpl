...
<?php } ?>
<link href="view/image/admin-favicon.ico" rel="shortcut icon" />
<?php foreach ($links as $link) { ?>
<link href="<?php echo $link['href']; ?>" rel="<?php echo $link['rel']; ?>" />
<?php } ?>
<!--link rel="stylesheet" type="text/css" href="view/stylesheet/stylesheet.css" /-->
<link rel="stylesheet" type="text/css" href="view/stylesheet/shades_of_grey_admin_theme.css" />
...
<link rel="stylesheet" type="text/css" href="view/javascript/jquery/ui/themes/smoothness/jquery-ui.css"/>
<script type="text/javascript" src="view/javascript/jquery/tabs.js"></script>
<script type="text/javascript" src="view/javascript/jquery/jquery.cookie.js"></script>
<script type="text/javascript" src="view/javascript/jquery/superfish/js/superfish.js"></script>
<script type="text/javascript" src="view/javascript/common.js"></script>
<script type="text/javascript" src="view/javascript/translit-0.1.js"></script>
...
<script type="text/javascript">
    function setLanguage(langId) {
        ...
        jQuery.cookie( 'adminLanguage', langId, { expires: 7, path: '/' } );

        if( url ) {
            window.location.href = 'index.php?route=' + url + '&token=<?php echo $token; ?>';
        }
    };
</script>
<script>
...
<div id="header">
  <div class="div1">
    <div class="div2"><img src="view/image/clean_logo.png" title="<?php echo $heading_title; ?>" onclick="location = '<?php echo $home; ?>'" /></div>
    <?php if ($logged) { ?>
    ...
    <ul class="left" style="display: none;">
      ...
      <li id="catalog"><a class="top"><?php echo $text_catalog; ?></a>
        <ul>
		  ...
		  <li><a href="<?php echo $lables; ?>"><?php echo $text_stick; ?></a></li>
      ...
      <li id="extension"><a class="top"><?php echo $text_extension; ?></a>
        <ul>
		  ...
		  <li><a href="<?php echo $seo; ?>"><?php echo 'SEO generator' ?></a></li>
        </ul>
      </li>
      ...
      <li id="help"><a class="top"><?php echo $text_help; ?></a>
        <ul>
          ...
          <li><a href="<?php echo $link_lanedit; ?>"><?php echo $text_documentation; ?></a></li>
        <?php if($this->user->hasPermission('access','common/elmanager')) { ?>
		  ...
		  <li><a href="<?php echo $bro_conf; ?>"><?php echo $text_cfg; ?></a></li>
		<?php } ?>
        </ul>
      </li>

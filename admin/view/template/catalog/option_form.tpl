        ...
        <table class="form">
          ...
          <tr>
            ...
            <td><select name="type">
                ...
                <?php } ?>
				<?php if ($type == 'mixed') { ?>
                <option value="mixed" selected><?php echo $text_mixed; ?></option>
                <?php } else { ?>
                <option value="mixed"><?php echo $text_mixed; ?></option>
                <?php } ?>
                <?php if ($type == 'radio') { ?>
...
$('select[name=\'type\']').bind('change', function() {
	if (this.value == 'select' || this.value == 'mixed' || this.value == 'radio' || this.value == 'checkbox' || this.value == 'image') {
		$('#option-value').show();
	} else {
		$('#option-value').hide();
	}

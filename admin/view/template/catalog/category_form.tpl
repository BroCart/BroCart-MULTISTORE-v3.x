...
<div id="content">
  ...
  <div class="box">
    <div class="heading">
      <h1><img src="view/image/category.png" alt="" /><?php echo $heading_title; ?><span class="infocname"></span></h1>
      <div class="buttons"><a onclick="$('#form').submit();" class="button"><?php echo $button_save; ?></a><a href="<?php echo $cancel; ?>" class="button"><?php echo $button_cancel; ?></a><a id="save_edit" class="button"><?php echo $text_apply; ?></a></div>
    </div>
    <div class="content">
          ...
          <div id="language<?php echo $language['language_id']; ?>">
            <table class="form">
              <tr>
                ...
                <td><input type="text" name="category_description[<?php echo $language['language_id']; ?>][name]" size="100" value="<?php echo isset($category_description[$language['language_id']]) ? $category_description[$language['language_id']]['name'] : ''; ?>"  id="cat_desc"/>
...
//--></script> 
<script type="text/javascript"><!--
	$infocname = $('input[name="category_description[<?php echo $this->config->get('config_language_id'); ?>][name]"]'); 
	$title = $('.infocname');
		if ($infocname.val() != '') {
			$title.html(' - ' + $infocname.val()); 
				}
				$infocname.keyup(function() {
					if ($infocname.val() != '') {
						$title.html(' - ' + $infocname.val()); 
					} else {
						$title.html('');
...
<script type="text/javascript"><!--
$('input#cat_desc').translit('send', 'input#keyw');
//--></script> 
<?php } ?> 
<?php echo $footer; ?>
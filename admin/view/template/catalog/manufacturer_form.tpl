...
<div id="content">
  ...
  <div class="box">
    ...
    <div class="content">
      <div id="tabs" class="htabs"><a href="#tab-manuf"><?php echo $text_tab_description; ?></a><a href="#tab-general"><?php echo $tab_general; ?></a></div>
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
		...
		<table class="form">
              ...
              <td><input type="text" name="name" value="<?php echo $name; ?>" size="100" id="manuf"/>
                <?php if ($error_name) { ?>
          ...
          <div id="language<?php echo $language['language_id']; ?>">
            <table class="form"> 
                ...
                <td><input type="text" name="manufacturer_description[<?php echo $language['language_id']; ?>][u_title]" size="100" value="<?php echo isset($manufacturer_description[$language['language_id']]) ? $manufacturer_description[$language['language_id']]['u_title'] : ''; ?>" />
                </td>
              </tr>
			<tr>
               <td><?php echo $text_h1; ?></td>
                <td><input type="text" name="manufacturer_description[<?php echo $language['language_id']; ?>][u_h1]" size="100" value="<?php echo isset($manufacturer_description[$language['language_id']]) ? $manufacturer_description[$language['language_id']]['u_h1'] : ''; ?>" />
                </td>
              </tr>
			<tr>
                <td><?php echo $text_h2; ?></td>
                <td><input type="text" name="manufacturer_description[<?php echo $language['language_id']; ?>][u_h2]" size="100" value="<?php echo isset($manufacturer_description[$language['language_id']]) ? $manufacturer_description[$language['language_id']]['u_h2'] : ''; ?>" />
                </td>
              </tr>
			  <tr>
                <td><?php echo $text_meta_description; ?></td>
              ...
              <tr>
                <td><?php echo $text_meta_keywords; ?></td>
...
<script type="text/javascript"><!--
$('input#manuf').translit('send', 'input#keyw');
//--></script> 
<?php } ?>
<?php echo $footer; ?>
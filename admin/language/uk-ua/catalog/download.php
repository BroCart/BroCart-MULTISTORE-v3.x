...
$_['help_mask'] = 'Рекомендуємо, щоб ім&#39;я файлу і маска були різні, для запобігання прямого доступу до файлів.';
...
$_['error_filename'] = 'Назва файлу повинно містити від 3 до 128 символів!';
...
$_['error_product'] = 'Увага: це завантаження не можна видалити, так як призначена до %s товарів!';
...
// Text
$_['text_success']       = 'Успешно: Опции изменены!';
$_['text_choose']        = 'Выбор';
$_['text_select']        = 'Список';
$_['text_radio']         = 'Переключатель';
$_['text_mixed']         = 'Список с рисунком';
...
// Error
$_['error_permission']   = 'Ошибка: У вас не достаточно прав для изменения опции!';
$_['error_name']         = 'Имя опции должно быть от 1 до 128 символов!';
$_['error_type']         = 'Ошибка: Не указано значение опции!';
$_['error_option_value'] = 'Значение опции должно быть от 1 до 128!';
$_['error_product']      = 'Ошибка: Эта опция не может быть удалена, поскольку она в настоящий момент присвоена %s продуктам!';
?>
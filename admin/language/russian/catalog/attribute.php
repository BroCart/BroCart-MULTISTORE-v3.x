...
// Text
$_['text_success']		= 'Успешно: Атрибуты успешно обновлены!';
...
// Error
$_['error_permission']		= 'Ошибка: У Вас нет прав для изменения атрибутов!';
$_['error_name']		= 'Название атрибута должно быть от 3 до 64 символов!';
$_['error_product']		= 'Ошибка: Этот атрибут не может быть удален, так как назначен %s товарам!';
?>
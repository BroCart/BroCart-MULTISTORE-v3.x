...
// Text
$_['text_success']     = 'Успешно: Список единиц веса обновлен!';
...
// Error
$_['error_permission'] = 'Ошибка: У Вас нет прав для изменения списка единиц веса!';
...
$_['error_default']    = 'Ошибка: Единица веса не может быть удалена, поскольку она установлена по умолчанию!';
$_['error_product']    = 'Ошибка: Единица веса не может быть удалена, поскольку она прикреплена к %s товару(ам)!';
?>
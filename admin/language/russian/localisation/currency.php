...
// Text
$_['text_success']         = 'Успешно: Список валют обновлен';
...
// Error
$_['error_permission']     = 'Ошибка: У Вас нет прав для изменения списка валют';
$_['error_title']          = 'Название валюты должно быть от 3 до 32 символов!';
$_['error_code']           = 'Код валюты должен состоять из 3 символов!';
$_['error_default']        = 'Ошибка: Валюту нельзя удалить, поскольку она назначена по умолчанию!';
$_['error_store']          = 'Ошибка: Валюту нельзя удалить, поскольку она используется в %s магазине(ах)!';
$_['error_order']          = 'Ошибка: Валюту нельзя удалить, поскольку она назначена для %s заказа(ов)';
?>
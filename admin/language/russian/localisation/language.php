...
// Text
$_['text_success']      = 'Успешно: Список языков обновлен!';
...
// Error
$_['error_permission']  = 'Ошибка: У Вас нет прав для изменения списка языков!';
...
$_['error_default']     = 'Ошибка: Язык не может быть удален, поскольку он используется по умолчанию!';
$_['error_admin']       = 'Ошибка: Язык не может быть исключен, поскольку он является языком Администратора';
$_['error_store']       = 'Ошибка: Язык не может быть удален, поскольку он используется в %s магазине(ах)!';
$_['error_order']       = 'Ошибка: Язык не может быть удален, поскольку он используется в %s заказе(ах)!';
?>
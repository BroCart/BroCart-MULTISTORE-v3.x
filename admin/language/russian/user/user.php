...
// Text
$_['text_success']      = 'Успешно: Список пользователей обновлен!';
...
// Error
$_['error_permission'] = 'Ошибка: У Вас нет прав для изменения списка пользователей!';
$_['error_account']    = 'Ошибка: Вы не можете удалить свой собственный аккаунт!';
$_['error_exists']     = 'Ошибка: Имя пользователя уже используется!';

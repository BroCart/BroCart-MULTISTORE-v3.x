...
$_['button_vqcache_dump']  = 'Дамп файлов';
...
$_['entry_backup']         = 'Backup VQMod файлов:';
$_['entry_ext_store']      = 'Последняя версия:';
$_['entry_ext_version']    = 'Версия менеджера:';
$_['entry_forum']          = 'OpenCart Forum Thread:';
$_['entry_license']        = 'License:';
$_['entry_upload']         = 'VQMod загрузить файл:';
...
$_['error_vqmod_install_link']         = 'VQMod не установлен в BROcart!  Пожалуйста, установите VQMod по пути <a href="%1$s">%1$s</a>.  Или скачайте последнюю версию VQMod из репозитария <a href="http://code.google.com/p/vqmod/" target="_blank">http://code.google.com/p/vqmod/</a>.';

...
// Text
$_['text_success']            = 'Успешно: Вы изменили данные о покупателях!';
$_['text_default']            = 'По умолчанию';
$_['text_approved']           = 'Вы активировали %s аккаунт!';
$_['text_wait']               = 'Подождите!';
$_['text_balance']            = 'Баланс:';
$_['text_add_ban_ip']       = 'Добавить в черный список';
$_['text_remove_ban_ip']    = 'Удалить черный список';
...
$_['error_permission']        = 'Ошибка: У Вас нет прав для изменения покупателей!';

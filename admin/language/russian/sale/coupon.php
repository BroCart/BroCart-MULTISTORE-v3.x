...
$_['entry_category']      = 'Категория:<br /><span class="help">Выберите все продукты под выбранную категорию.</span>';
...
// Error
$_['error_permission']    = 'Ошибка: У Вас нет прав для изменения купонов!';
$_['error_exists']        = 'Ошибка: Скидочный купон уже используется!';

...
// Text
$_['text_success']				= 'Успешно: Магазины обновлены!';
$_['text_items']                   = 'Items';
$_['text_tax']                     = 'Taxes';
...
$_['error_permission']			= 'Ошибка: У Вас нет прав для управления магазинами!';
...
$_['error_default']				= 'Ошибка: Нельзя удалить основной магазин!';
$_['error_store']				= 'Ошибка: Этот магазин не может быть удален, поскольку он прикреплен к %s заказам!';
?>
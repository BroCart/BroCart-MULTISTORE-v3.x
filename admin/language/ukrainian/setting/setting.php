...
$_['entry_meta_keywords'] = 'Введіть ключові слова:'; #Baco 
$_['entry_secure'] = 'Використовувати SSL:'; #Baco
$_['entry_shared'] = 'Дозволити довготривалу сесію:'; #Baco
$_['entry_robots'] = 'Robots'; #Bacoentry_file_extension_allowed
$_['entry_file_extension_allowed'] = 'Дозволені формати файлів'; #Baco
$_['entry_file_mime_allowed'] = 'Співвідношення файлів'; #Baco
$_['entry_password'] = 'Показувати "Забув пароль"'; #Baco
$_['entry_yandex_metrika']   = 'Код Yandex Metrika:<br /><span class="help">Ввійдіть у Ваш <a onclick="window.open(\'http://metrika.yandex.ru/\');"><u>Yandex Metrika аккаунт</u></a> та після настройки добавте сюди код виданий Yandex Metrika.</span>';
$_['tab_ftp'] = 'ФТП'; #Baco
...
$_['entry_cancel_status']        = 'Статус відміненого замовлення:<br /><span class="help">Статус замовлення, при виборі котрого повертається кіл-ть товару та опцій на залишок складу.</span>';
...
$_['entry_h1']             = 'Введіть тег H1:'; //Baco
$_['entry_full_desc']             = 'Повний опис:'; //Baco
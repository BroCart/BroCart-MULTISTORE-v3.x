...
$_['entry_main_category']	 = 'Main category:<br/><span class="help">Select main category to address SEO URL.  For example, if you select a product category Desktop for Apple Cine4ma 30 then link to the product will be the next your_domain/desktop/apple-cine4ma-30 If you do not select the main category of the address will be the your_domain/apple-cine4ma-30</span>';

$_['text_autometa']            = 'Auto change meta tags<br/><span class="help">Uncheck, if you want to change description or tags, and this not to affect the meta tags.</span>';
$_['text_titles']            = 'Document Title<br/><span class="help">If you leave it empty, document title will take product name. Change if you want it different for seo</span>';
$_['text_h1']            = 'Heading Title (h1)<br/><span class="help">If you leave it empty, heading title (h1) will take product name. Change if you want it different for seo</span>';
$_['text_h2']            = 'Secondary Heading Title (h2)<br/><span class="help">Optional, displays under h1 title. Write something small and additional to heading 1, or title for better seo.</span>';
// Column
...
$_['entry_info']           = 'Choise info:';
$_['tab_label'] = 'Stickers'; #34485
$_['entry_labels'] = 'Choise sticker'; #31652
$_['entry_del'] = 'Delete'; #31653
$_['entry_labels_name'] = 'Name'; #31654
// Error

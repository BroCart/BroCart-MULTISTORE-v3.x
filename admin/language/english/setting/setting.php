...
$_['entry_cancel_status']        = 'Cancel Order Status:<br /><span class="help">Set the order status rechange quantity products and options back.</span>';
...
$_['entry_yandex_metrika']     = 'Yandex Metrika Code:<br /><span class="help">Login to your <a onclick="window.open(\'http://metrika.yandex.ru/\');"><u>Yandex Metrika</u></a> account and after creating your web site profile copy and paste the metrika code into this field.</span>';
// Error
...
$_['entry_h1']             = 'Entry tag H1:';
$_['entry_full_desc']             = 'Full description:';
?>

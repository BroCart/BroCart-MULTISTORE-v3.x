...
class ControllerCatalogProduct extends Controller {
	...
	public function edit() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			if (isset($this->request->post['saveandstay']) && $this->request->post['saveandstay'] == '1') {
	...
	protected function getList() {
		...
		$data['catlasts'] = $this->model_catalog_category->getCatLasts(0);
		...
		$data['sort_category'] = $this->url->link('catalog/product', 'user_token=' . $this->session->data['user_token'] . '&sort=p2c.category' . $url, true);

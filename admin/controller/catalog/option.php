...
class ControllerCatalogOption extends Controller {
	...
	protected function getForm() {
		...
		$this->data['text_mixed'] = $this->language->get('text_mixed');
	...
	protected function validateForm() {
		...
		if (($this->request->post['type'] == 'select' || $this->request->post['type'] == 'mixed' || $this->request->post['type'] == 'radio' || $this->request->post['type'] == 'checkbox') && !isset($this->request->post['option_value'])) {

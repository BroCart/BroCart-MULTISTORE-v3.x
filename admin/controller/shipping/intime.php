...
class ControllerShippingintime extends Controller {
    ...
    public function index() {
	  ...
	  $this->document->setTitle($this->language->get('heading_title'));
        ...
        $this->data['action'] = HTTPS_SERVER . 'index.php?route=shipping/intime&token=' . $this->session->data['token'];
        ...
        if (isset($this->request->post['intime_min_total_for_free_delivery'])) {
            $this->data['intime_min_total_for_free_delivery'] = $this->request->post['intime_min_total_for_free_delivery'];
        } else {
            $this->data['intime_min_total_for_free_delivery'] = $this->config->get('intime_min_total_for_free_delivery');
        }

        if (isset($this->request->post['intime_delivery_price'])) {
            $this->data['intime_delivery_price'] = $this->request->post['intime_delivery_price'];
        } else {
            $this->data['intime_delivery_price'] = $this->config->get('intime_delivery_price');
        }

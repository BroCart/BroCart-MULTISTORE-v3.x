...
class ControllerExtensionThemeDefault extends Controller {
	...
	public function index() {
		...
		if (isset($this->request->post['theme_default_version'])) {
			$data['theme_default_version'] = $this->request->post['theme_default_version'];
		} elseif (isset($setting_info['theme_default_version'])) {
			$data['theme_default_version'] = $setting_info['theme_default_version'];
		} else {
			$data['theme_default_version'] = false;
		}

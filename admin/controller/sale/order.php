  	...
  	protected function getList() {
    	...
    	foreach ($results as $result) {
			...
			$this->data['orders'][] = array(
				...
				'shipping_method'  => $result['shipping_method'],  'shipping_cost' => $result['shipping_costs'],
				'action'        => $action
			);
		}
		...
		$this->data['column_sh_cost'] = $this->language->get('column_sh_cost');
		$this->data['column_sh_method'] = $this->language->get('column_sh_method');

...
class ModelExtensionShippingIntime extends Model {
    ...
    function getQuote($address) {
        ...
        $image = HTTP_SERVER.'image/catalog/shipping/intime.jpg';
        ...
        if ($status) {
            ...
            $quote_data['intime'] = array(
                ...
                'cost' => $this->config->get('shipping_intime_cost'),
                'tax_class_id' => $this->config->get('shipping_intime_tax_class_id'),
                'text' => $this->currency->format($this->tax->calculate($this->config->get('shipping_intime_cost'), $this->config->get('shipping_intime_tax_class_id'), $this->config->get('shipping_config_tax')), $this->session->data['currency'])
            );
            ...
            $method_data = array(
                ...
                'quote' => $quote_data,
                'sort_order' => $this->config->get('shipping_intime_sort_order'),
                'error' => false
            );
        }

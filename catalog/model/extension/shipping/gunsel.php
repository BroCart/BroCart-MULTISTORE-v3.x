...
class ModelExtensionShippingGunsel extends Model {
    ...
    function getQuote($address) {
        ...
        $image = HTTP_SERVER.'image/catalog/shipping/gunsel.jpg';
        ...
        if ($status) {
            ...
            $quote_data['gunsel'] = array(
                ...
                'cost' => $this->config->get('shipping_gunsel_cost'),
                'tax_class_id' => $this->config->get('shipping_gunsel_tax_class_id'),
                'text' => $this->currency->format($this->tax->calculate($this->config->get('shipping_gunsel_cost'), $this->config->get('shipping_gunsel_tax_class_id'), $this->config->get('shipping_config_tax')), $this->session->data['currency'])
            );
            ...
            $method_data = array(
                ...
                'quote' => $quote_data,
                'sort_order' => $this->config->get('shipping_gunsel_sort_order'),
                'error' => false
            );
        }

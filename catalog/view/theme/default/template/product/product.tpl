 ...
 <div class="breadcrumb" xmlns:v="http://rdf.data-vocabulary.org/#">
  ...
  <div class="product-info">
	...
	<h1><?php echo $heading_title; ?></h1>		
	  <div class="description">
		...
		<?php if (isset($location) && ($location == '1')) { ?>
        <span><a href="<?php echo $lochref; ?>" title="<?php echo $loctoinfo['title']; ?>" class="colorbox"><?php echo $loctoinfo['title']; ?></a></span><br />
        <?php } elseif (isset($location) && ($location == '2')) { ?>
		<span><?php echo $loctoinfo['title']; ?></span><br />
		<?php } ?>
		</div>
      <?php if ($price) { ?>
  ...
  <?php if ($product_tabs_1) { ?>
	...
	<?php if ($product_tabs_3) { ?>
			...
			<?php } ?>
	<?php } ?>
	<?php if ($this->config->get('comment_enabled') == '1') { ?>
  ...
  <?php if ($product_tabs_1) { ?>
		...
		<?php } ?>
<?php } ?>
  <div id="tab-description" class="tab-content" unselectable="on" oncopy="return false" oncontextmenu="return false" onselectstart="return false"><?php echo $description; ?></div>
  <?php if ($product_tabs_2) { ?>
		<?php foreach($product_tabs_2 as $product_tab_2) { ?>

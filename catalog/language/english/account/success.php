...
$_['text_approval'] = '<p>Thank you for registering with %s!</p><p>You must approve by email once and your account has been activated by the store owner.</p><p>If you have ANY questions about the operation of this online shop, please <a href="%s">contact the store owner</a>.</p>';

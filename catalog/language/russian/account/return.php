...
$_['text_return_detail'] = 'Дополнительная информация';
$_['text_description']   = '<p>Пожалуйста заполните форму запроса на возврат товар.</p>';
...
$_['column_date_added']  = 'Дата подачи';

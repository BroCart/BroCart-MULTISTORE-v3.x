...
<div id="content">
  ...
  <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
    <p>1. Настройке конфигурацию PHP с необходимыми требованиями.</p>
    <fieldset>
      <table>
        <tr>
          <th width="35%" align="left"><b>PHP требования</b></th>
    ...
    <p>2. Убедитесь, что данные расширения PHP установлены (уточнить у хостинг провайдера).</p>
    <fieldset>
      <table>
        <tr>
    ...
    <p>3. Проверьте, правильно ли установлены права на файлы (CHMOD).</p>
    <fieldset>
      <table>
        <tr>
        ...
        <tr>
          ...
          <td><?php if (!file_exists($config_catalog)) { ?>
            ...
            <span class="bad">Недоступно</span>
          <?php } else { ?>
          <span class="good">Доступно</span>
          <?php } ?>
            </td>
        </tr>
        <tr>
    ...
    <p>4. Проверьте, правильно ли установлены права на каталоги (CHMOD).</p>
    <fieldset>
      <table>
        <tr>
          <th align="left"><b>Каталог</b></th>
          <th align="left"><b>Статус</b></th>
        </tr>
        <tr>
          <td><?php echo $cache . '/'; ?></td>
          <td><?php echo is_writable($cache) ? '<span class="good">Доступно</span>' : '<span class="bad">Недоступно</span>'; ?></td>
        </tr>
        <tr>
          <td><?php echo $logs . '/'; ?></td>
          <td><?php echo is_writable($logs) ? '<span class="good">Доступно</span>' : '<span class="bad">Недоступно</span>'; ?></td>
        </tr>
        <tr>
          <td><?php echo $image . '/'; ?></td>
          <td><?php echo is_writable($image) ? '<span class="good">Доступно</span>' : '<span class="bad">Недоступно</span>'; ?></td>
        </tr>
        <tr>
          <td><?php echo $image_cache . '/'; ?></td>
          <td><?php echo is_writable($image_cache) ? '<span class="good">Доступно</span>' : '<span class="bad"></span>'; ?></td>
        </tr>
        <tr>
          <td><?php echo $image_data . '/'; ?></td>
          <td><?php echo is_writable($image_data) ? '<span class="good">Доступно</span>' : '<span class="bad">Недоступно</span>'; ?></td>
        </tr>
        <tr>
          <td><?php echo $download . '/'; ?></td>
          <td><?php echo is_writable($download) ? '<span class="good">Доступно</span>' : '<span class="bad">Недоступно</span>'; ?></td>
        </tr>
      </table>
    </fieldset>
    <div class="buttons">

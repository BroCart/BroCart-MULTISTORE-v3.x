...
class ModelUpgrade1006 extends Model {
	public function upgrade() {
		...
		$this->db->query("UPDATE `" . DB_PREFIX . "setting` SET `value` = 'ru-ua' WHERE `key` = 'config_language' AND `value` = 'ru'");
		$this->db->query("UPDATE `" . DB_PREFIX . "setting` SET `value` = 'ru-ua' WHERE `key` = 'config_admin_language' AND `value` = 'ru'");
		$this->db->query("UPDATE `" . DB_PREFIX . "language` SET `code` = 'ru-ua' WHERE `code` = 'ru'");
